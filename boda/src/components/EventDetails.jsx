...
const EventDetails = () => {
  ...
  const eventData = {
    ceremonia: {
      ...
      time: "12:00",
      location: "Parroquía Virgen del Rosario de Torre Pacheco",
      address: "Calle Principal 123, Centro Histórico",
      description:
        "Acompáñanos en este momento sagrado donde uniremos nuestras vidas ante Dios.",
      dress_code:
        "Formal - Colores sugeridos: tonos pasteles, evitar blanco y negro",
      icon: "⛪",
    },
    celebracion: {
      title: "Celebración",
      time: "14:00",
      location: "Finca Jurosa",
      address: "Avenida de los Rosales 456, Jardines del Norte",
      description:
        "Continuemos la celebración con cena, baile y mucha diversión hasta altas horas.",
        ...
        <div className="additional-info">
          <div className="info-grid">
            <div className="info-card">
              <h4>🚗 Transporte</h4>
              <p>
                Contaremos con servicio de transporte desde la iglesia hasta el
                salón de eventos. El autobús saldrá 15 minutos después de la
                ceremonia.
              </p>
            </div>
            <div className="info-card">
              ...
              <p>
                ...
                algo, tenemos una mesa de regalos en Liverpool y Palacio de
                Hierro.
              </p>
            </div>
            <div className="info-card">
              <h4>📱 Hashtag</h4>
              <p>
                Comparte tus fotos usando nuestro hashtag oficial:{" "}
                <strong>#RaulYLaura2026</strong>
              </p>
            </div>
          </div>
        </div>
